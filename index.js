 ...
 *
 * Code generated by Gaiman version 1.0.0-beta.2
 * https://gaiman.js.org
 */
...
async function main() {
    try {
        let $_greetings = '   \r\n  ____  ______     ______  \r\n |  _ \\/ ___\\ \\   / /  _ \\ \r\n | |_) \\___ \\\\ \\ / /| |_) |\r\n |  _ < ___) |\\ V / |  __/ \r\n |_| \\_\\____/  \\_/  |_|    \r\n           \r\nWelcome to Story Play\r\n\r';
        gaiman.echo($_greetings);
        await gaiman.sleep(100);
        await gaiman.echo_extra(`Welcome stranger, You're invite to the party!`, 50);
        await gaiman.sleep(100);
        await gaiman.echo_extra(`Do you want to come?`, 50);
        let $_confirm = await gaiman.ask(`yes/no? `);
        if ($$__m = String($_confirm).match(/yes/i), !!$$__m) {
            await gaiman.echo_extra(`That's fantastic!!! 🙌`, 50);
        }
        await gaiman.sleep(100);
        await gaiman.echo_extra(`hmmmm... okay! Now it's time for you to find the golden egg 🥚`, 100);
        await gaiman.sleep(100);
        await gaiman.echo_extra(`Well.... I'm waiting..`, 150);
        await gaiman.echo_extra(`......`, 300);
        await gaiman.sleep(100);
        gaiman.echo(`Just kidding!`);
        await gaiman.echo_extra(`The party will be a West 123 ave, Next to the Skateboard Shop!`, 50);
        await gaiman.echo_extra(`We have all kinds of drinks and everyone must wear blue or yellow shirts`, 50);
        gaiman.echo(`See you soon cheers! 🎉🎉🎉`);
    } catch (e) {
        gaiman.error(e);
    }
}
